...
Other Notes:
    Available datasets to load
        imagenet... _v2, _resized, _pi, _lt
        cifar... 10, 100, 100_n, 10_1, 10_h, 10_n
        cats_vs_dogs

'''

# TODO - Add plot about the Binary Recall & Precision over many thresholds
# TODO - Include Fine-Tuning w/ all layers trainable?
...
def build_vgg16_transfer_learning(img_size, num_classes):
    # Load base VGG16
    ...
    # OUTPUT artifacts
    path_vgg16 = os.path.join(cfg.BASE_PATH,
...
model = build_vgg16_transfer_learning(cfg.IMAGE_SIZE, cfg.NUM_CLASSES)
